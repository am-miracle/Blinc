...
impl WindowsTheme {
    ...
    fn light_shadows() -> ShadowTokens {
        ...
        ShadowTokens {
            ...
            shadow_xl: vec![Shadow::new(0.0, 16.0, 24.0, 0.0, base_color.with_alpha(0.12))],
            shadow_2xl: vec![Shadow::new(0.0, 24.0, 48.0, 0.0, base_color.with_alpha(0.16))],
    ...
    fn dark_shadows() -> ShadowTokens {
        ...
        ShadowTokens {
            ...
            shadow_lg: vec![Shadow::new(0.0, 8.0, 16.0, 0.0, base_color.with_alpha(0.32))],
            shadow_xl: vec![Shadow::new(0.0, 16.0, 24.0, 0.0, base_color.with_alpha(0.36))],
            shadow_2xl: vec![Shadow::new(0.0, 24.0, 48.0, 0.0, base_color.with_alpha(0.44))],
