...
pub use shaders::{
    ...
    GLOW_SHADER, IMAGE_SHADER, LAYER_COMPOSITE_SHADER, PATH_SHADER, SDF_3D_SHADER,
    SDF_CORE_SHADER, SDF_NOTCH_SHADER, SDF_SHADER, SDF_SHADOW_SHADER, SIMPLE_GLASS_SHADER,
    TEXT_SHADER,
};
