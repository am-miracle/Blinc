...
const INFERABLE_DEPS: &[(&str, &str, &str)] = &[
    ...
    (
        "blinc_gltf::",
        "blinc_gltf",
        r#"{ git = "https://github.com/project-blinc/blinc_gltf.git", rev = "12350122ce9fe5dd87b0cf4d8824dd699e2a9a10", features = ["platform-assets"] }"#,
    ),
    (
        "blinc_skeleton::",
        "blinc_skeleton",
        r#"{ git = "https://github.com/project-blinc/blinc_skeleton.git", rev = "dc8026cae2bc55c7f07d43ed9377c223c6159ce3" }"#,
    ),
    (
        "blinc_input::",
        "blinc_input",
