...
const INFERABLE_DEPS: &[(&str, &str, &str)] = &[
    ...
    (
        ...
        r#"{ git = "https://github.com/project-blinc/blinc_node_editor.git", rev = "6240e984dd306a06bbec3a84fcaddea306f5cc14" }"#,
    ),
    (
        "blinc_portal_ui::",
        "blinc_portal_ui",
        ...
        r#"{ git = "https://github.com/project-blinc/blinc_portal_ui.git", rev = "0c0a89f360ce19c1762ba5bef2d9aff4362ff504" }"#,
    ),
