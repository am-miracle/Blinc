...
const INFERABLE_DEPS: &[(&str, &str, &str)] = &[
    ...
    (
        "blinc_gltf::",
        "blinc_gltf",
        r#"{ git = "https://github.com/project-blinc/blinc_gltf.git", rev = "ba7a1ce96a12fe608b771b932d07c34fdb7830cb", features = ["platform-assets"] }"#,
    ),
    (
        "blinc_skeleton::",
        "blinc_skeleton",
    ...
    (
        "blinc_input::",
        "blinc_input",
        r#"{ git = "https://github.com/project-blinc/blinc_input.git", rev = "12be3c954055d44322eaa1e82b957640fa27baff" }"#,
    ),
];
