...
const INFERABLE_DEPS: &[(&str, &str, &str)] = &[
    ...
    (
        "blinc_gltf::",
        "blinc_gltf",
        r#"{ git = "https://github.com/project-blinc/blinc_gltf.git", rev = "1f537997833ca8850684e8f688a7d488818b35b8", features = ["platform-assets"] }"#,
    ),
    (
        "blinc_skeleton::",
        "blinc_skeleton",
        r#"{ git = "https://github.com/project-blinc/blinc_skeleton.git", rev = "cdf5a5d39fe47d3ba2ddad9699e1d7836fdb4be5" }"#,
    ),
    (
        "blinc_input::",
        "blinc_input",
